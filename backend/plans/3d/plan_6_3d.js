...
class ThreeDPlanViewer {
    constructor() {
        ...
        this.renderer = null;
        this.controls = null;
        this.planData = {"id":"plan_6","apartmentType":"3+1","streetFacingSides":4,"minUsableArea":800,"maxUsableArea":1500,"averageApartmentArea":110,"estimatedApartments":"7-14","name":"Dörtgen Lüks Blok - 3+1","description":"Dört sokağa bakan lüks apartman kompleksi","image":"plans/plan_6_3plus1_4side.svg","features":["Premium lokasyon","360 derece ışık","Geniş ortak alanlar","Lüks yaşam standardı"]};
        this.standards = {"livingRoom":{"width":5.5,"length":6,"height":2.8},"bedroom1":{"width":4.5,"length":5,"height":2.8},"bedroom2":{"width":4,"length":4.5,"height":2.8},"bedroom3":{"width":3.5,"length":4,"height":2.8},"kitchen":{"width":3.5,"length":4,"height":2.8},"bathroom":{"width":3,"length":3.5,"height":2.8},"hallway":{"width":1.8,"length":4,"height":2.8}};
