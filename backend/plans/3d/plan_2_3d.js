...
class ThreeDPlanViewer {
    constructor() {
        ...
        this.renderer = null;
        this.controls = null;
        this.planData = {"id":"plan_2","apartmentType":"2+1","streetFacingSides":2,"minUsableArea":400,"maxUsableArea":800,"averageApartmentArea":85,"estimatedApartments":"5-9","name":"Köşe Blok - 2+1","description":"İki sokağa bakan köşe apartman","image":"plans/plan_2_2plus1_2side.svg","features":["Köşe konumu avantajı","İki cephe ışık alımı","Orta ölçekli proje","Balkon imkanı"]};
