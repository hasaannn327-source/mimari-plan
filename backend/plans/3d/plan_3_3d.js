...
class ThreeDPlanViewer {
    constructor() {
        ...
        this.renderer = null;
        this.controls = null;
        this.planData = {"id":"plan_3","apartmentType":"2+1","streetFacingSides":3,"minUsableArea":600,"maxUsableArea":1000,"averageApartmentArea":85,"estimatedApartments":"7-12","name":"Üç Cepheli Blok - 2+1","description":"Üç sokağa bakan geniş apartman","image":"plans/plan_3_2plus1_3side.svg","features":["Mükemmel ışık alımı","Geniş balkon imkanları","Prestijli konum","Çoklu giriş seçeneği"]};
        this.standards = {"livingRoom":{"width":5,"length":5.5,"height":2.8},"bedroom1":{"width":4,"length":4.5,"height":2.8},"bedroom2":{"width":3.5,"length":4,"height":2.8},"kitchen":{"width":3,"length":3.5,"height":2.8},"bathroom":{"width":2.5,"length":3,"height":2.8},"hallway":{"width":1.5,"length":3.5,"height":2.8}};
