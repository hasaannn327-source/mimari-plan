...
class ThreeDPlanViewer {
    constructor() {
        ...
        this.renderer = null;
        this.controls = null;
        this.planData = {"id":"plan_1","apartmentType":"2+1","streetFacingSides":1,"minUsableArea":300,"maxUsableArea":600,"averageApartmentArea":85,"estimatedApartments":"3-7","name":"Tek Cepheli Küçük Blok - 2+1","description":"Tek sokağa bakan küçük apartman bloku","image":"plans/plan_1_2plus1_1side.svg","features":["Ekonomik yapım","Basit plan düzeni","Tek sokak cephesi","Küçük ölçekli proje"]};
