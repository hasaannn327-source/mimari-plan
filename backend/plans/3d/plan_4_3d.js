...
class ThreeDPlanViewer {
    constructor() {
        ...
        this.renderer = null;
        this.controls = null;
        this.planData = {"id":"plan_4","apartmentType":"3+1","streetFacingSides":1,"minUsableArea":450,"maxUsableArea":800,"averageApartmentArea":110,"estimatedApartments":"4-7","name":"Tek Cepheli Orta Blok - 3+1","description":"Tek sokağa bakan orta büyüklük apartman","image":"plans/plan_4_3plus1_1side.svg","features":["Geniş daire planları","3 yatak odası","Aile dostu tasarım","Uygun maliyetli"]};
