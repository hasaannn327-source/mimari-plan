...
class ThreeDPlanViewer {
    constructor() {
        ...
        this.renderer = null;
        this.controls = null;
        this.planData = {"id":"plan_5","apartmentType":"3+1","streetFacingSides":2,"minUsableArea":600,"maxUsableArea":1200,"averageApartmentArea":110,"estimatedApartments":"5-11","name":"Köşe Büyük Blok - 3+1","description":"İki sokağa bakan büyük apartman","image":"plans/plan_5_3plus1_2side.svg","features":["Lüks daire planları","Geniş balkon alanları","İki cephe avantajı","Prestijli yaşam"]};
