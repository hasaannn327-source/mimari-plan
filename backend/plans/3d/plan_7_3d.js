...
class ThreeDPlanViewer {
    constructor() {
        ...
        this.renderer = null;
        this.controls = null;
        this.planData = {"id":"plan_7","apartmentType":"1+1","streetFacingSides":1,"minUsableArea":200,"maxUsableArea":400,"averageApartmentArea":60,"estimatedApartments":"3-7","name":"Kompakt Blok - 1+1","description":"Tek kişilik veya çift için kompakt apartman","image":"plans/plan_7_1plus1_1side.svg","features":["Ekonomik seçenek","Genç profesyoneller için","Düşük işletme gideri","Şehir merkezi uygun"]};
        this.standards = {"livingRoom":{"width":4.5,"length":5,"height":2.8},"bedroom":{"width":3.5,"length":4,"height":2.8},"kitchen":{"width":2.5,"length":3,"height":2.8},"bathroom":{"width":2,"length":2.5,"height":2.8},"hallway":{"width":1.2,"length":3,"height":2.8}};
